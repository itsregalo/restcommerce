    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(choices=[('CEO', 'CEO'), ('Marketing Officer', 'Marketing Officer'), ('Customer Care', 'Customer Care'), ('Quality Officer', 'Quality Officer')], max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_pic', models.ImageField(default='images/profile/default-profile.jpg', upload_to='images/profile/customer')),
